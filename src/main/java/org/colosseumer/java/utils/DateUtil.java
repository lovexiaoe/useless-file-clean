...
/**
 * 时间工具类 ,使用SimpleDateFormat, 进行了封装，将每种format缓存起来，所以是线程安全。
 * 
 * @author hesicare
 */
public class DateUtil
{
    ...
    public static void main(String[] args) {
		Date parseDate = DateUtil.parseDate(DateUtil.parseDateToStr("yyyy-MM-dd", new Date()) + " 04:00");
		System.out.println(DateUtil.getDate(YYYYMMDD));
		System.out.println(addTime(parseDate, Calendar.DAY_OF_MONTH, 1));
